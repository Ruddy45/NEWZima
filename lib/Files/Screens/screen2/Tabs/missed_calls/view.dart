...
class Missed_callsPage extends StatelessWidget {
  Missed_callsPage({Key? key}) : super(key: key);

  final logic = Get.put(Missed_callsLogic());
  final state = Get.find<Missed_callsLogic>().state;
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              trailing: const Icon(Icons.call_missed, color: Colors.red,size: 15,),
